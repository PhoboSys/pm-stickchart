...
export declare class EntityUtils {
    ...
    static getUnpropagatedTransactions(context: RenderingContext, entityid: string, entityBlock: any): any;
    static isEntityPropagating(context: RenderingContext, entityid: string, entityBlock: any): boolean;
