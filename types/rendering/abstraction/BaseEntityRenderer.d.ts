...
export declare abstract class BaseEntityRenderer extends BaseRenderer {
    ...
    protected isEntityPropagating(context: RenderingContext, entityid: string): any;
    protected isEnityVerified(context: RenderingContext, entityid: string): any;
    protected isEnityReverted(context: RenderingContext, entityid: string): any;
}
