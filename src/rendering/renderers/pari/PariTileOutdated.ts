...
import {
    UP_ICON_TEXTURE_OUTDATED,
    DOWN_ICON_TEXTURE_OUTDATED,
    ZERO_ICON_TEXTURE_OUTDATED,
...
export class PariTileOutdated extends BaseParisRenderer {

    static readonly PARI_TILE_OUTDATED_ID: symbol = Symbol('PARI_TILE_OUTDATED_ID')
    ...
    private getPositionIconTextureName(position: EPosition): symbol {
        ...
        switch (position) {
            case EPosition.Up:
                return UP_ICON_TEXTURE_OUTDATED
            case EPosition.Down:
                return DOWN_ICON_TEXTURE_OUTDATED
            case EPosition.Zero:
                return ZERO_ICON_TEXTURE_OUTDATED
