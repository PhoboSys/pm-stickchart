import { Graphics, Container, Sprite, gsap, Texture } from '../../lib/pixi'
    ...
    protected update(
        ...
        for (const pari of context.paris) {
            ...
            if (pari.position === 'POS') {
                ...
                const [gradientPos, statepos] = this.get('gradientPos', () => new Sprite(<Texture>context.textures.get(UP_WAGET_TEXTURE)))
            ...
            if (pari.position === 'NEG') {
                ...
                const [gradientNeg, stateneg] = this.get('gradientNeg', () => new Sprite(<Texture>context.textures.get(DOWN_WAGET_TEXTURE)))
