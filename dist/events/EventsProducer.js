...
class EventsProducer {
    constructor(target, canvas, stage) {
        ...
        this.pointermove = (e) => this.target.dispatchEvent(new _events_1.PointermoveEvent(e));
        this.pointerleave = (e) => this.target.dispatchEvent(new _events_1.PointerleaveEvent(e));
