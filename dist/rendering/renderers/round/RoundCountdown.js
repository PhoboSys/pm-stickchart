...
class RoundCountdown extends BaseRoundsRenderer_1.BaseRoundsRenderer {
    get animations() {
    ...
    get rendererId() {
        return RoundCountdown.ROUND_LOCK_COUNTDOWN_ID;
    }
    countdown() {
    ...
    updateRound(round, context, container) {
        ...
        this.updateText(round, context, container);
    }
    updateBackground(round, context, container) {
        var _a;
        const { width, height, } = context.screen;
        const { lockDate, startDate, endDate } = round;
    ...
    updateText(round, context, container) {
        const { roundid, lockDate, endDate } = round;
...
exports.RoundCountdown = RoundCountdown;
RoundCountdown.ROUND_LOCK_COUNTDOWN_ID = Symbol('ROUND_LOCK_COUNTDOWN_ID');
//# sourceMappingURL=RoundCountdown.js.map