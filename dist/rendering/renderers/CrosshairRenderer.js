...
class CrosshairRenderer extends __1.BaseRenderer {
    ...
    updateVertical(container) {
        ...
        const timeValue = _rendering_1.DateUtils.formatUnixTSToHHmm(time);
    ...
    updateHorizontal(container) {
        ...
        const [coveredText, coveredTextState] = this.get('priceCoveredText', () => __1.GraphicUtils.createCoveredText(ui_1.default.currency(price, _constants_1.USD), [width, y], this.priceCoverStyle));
        const textGraphic = coveredText.getChildAt(1);
